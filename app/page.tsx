    ...
    <>
      ...
      <section id="features" className="shell">
        ...
        <p className="sub rv" style={{ marginTop: 16 }}>
          Most tools hand you a list. Premise hands you a list, the reasoning behind every line,
          ...
          >
            <div style={{ flex: 1, minWidth: 260 }}>
              ...
              <p className="p" style={{ marginTop: 8 }}>
                Write a premise outside the universe and Premise stops, says so, and shows you what
